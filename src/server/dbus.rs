...
///
/// Note:
/// On linux, we use dbus to communicate multiple shopremote process.
...
const DBUS_NAME: &str = "org.shopremote.shopremote";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ShopRemote DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.shopremote.shopremote /dbus org.shopremote.shopremote.NewConnection string:'PEER_ID'`
