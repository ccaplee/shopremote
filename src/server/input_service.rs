...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // It looks like https://github.com/shopremote/shopremote/issues/9729#issuecomment-2432306822
            // 1. Press "Command" key in ShopRemote
            // 2. Move the physical mouse
            // 3. Press "V" key in ShopRemote
            ...
            // we consider only ShopRemote operates the controlled side.
            //
...
#[cfg(target_os = "macos")]
fn key_sleep() {
    // https://www.reddit.com/r/shopremote/comments/1kn1w5x/typing_lags_when_connecting_to_macos_clients/
    //
    ...
    // Though `/Applications/ShopRemote.app/Contents/MacOS/shopremote --server` in terminal is ok.
    let now = Instant::now();
...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/shopremote/shopremote/issues/332
