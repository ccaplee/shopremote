...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/ShopRemote.app/Contents/MacOS/ShopRemote", "XPC_SERVICE_NAME=kr.co.ilv.shopremote_server"
...
mod tests {
    ...
    #[tokio::test]
    async fn test_ShopRemote_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = shopremote_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_ShopRemote_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
