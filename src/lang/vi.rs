...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới ShopRemote..."),
        ...
        ("install_tip", "Do cơ chế UAC, ShopRemote có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt ShopRemote vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho ShopRemote."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho ShopRemote."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [ShopRemote Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep ShopRemote background service", "Giữ dịch vụ ShopRemote chạy nền"),
        ...
        ("Show ShopRemote", "Hiện ShopRemote"),
        ...
        ("verify_shopremote_password_tip", "Xác thực mật khẩu ShopRemote"),
        ...
        ("scam_text2", "Chỉ sử dụng ShopRemote với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ ShopRemote mở"),
        ...
        ("floating_window_tip", "Giữ ShopRemote trên cùng"),
        ...
        ("About ShopRemote", "Về ShopRemote"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
