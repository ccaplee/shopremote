...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "ShopRemote może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować ShopRemote w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić ShopRemote przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić ShopRemote na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [ShopRemote Input]."),
        ...
        ("Language", "Język"),
        ("Keep ShopRemote background service", "Zachowaj usługę ShopRemote w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji ShopRemote, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show ShopRemote", "Pokaż ShopRemote"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji ShopRemote uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać ShopRemote uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z ShopRemote w Twojej sieci."),
        ...
        ("verify_shopremote_password_tip", "Weryfikuj hasło ShopRemote"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu ShopRemote - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Proszę zaktualizować ShopRemote Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu ShopRemote po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez ShopRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno ShopRemote jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę ShopRemote w tle"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Proszę zaktualizować zdalny klient ShopRemote do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie ShopRemote weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, ShopRemote pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, ShopRemote nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS ShopRemote nie obsługuje tej funkcji."),
