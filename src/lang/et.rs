...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "ShopRemotei võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa ShopRemote mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et ShopRemote oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb ShopRemoteile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb ShopRemoteile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma ShopRemoteile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [ShopRemote Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep ShopRemote background service", "Säilita ShopRemotei taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele ShopRemotei rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show ShopRemote", "Kuva ShopRemote"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma ShopRemoteile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma ShopRemoteile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud ShopRemotei kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_shopremote_password_tip", "Kinnita ShopRemotei parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul ShopRemotei kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Palun täienda ShopRemote Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib ShopRemoteil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb ShopRemoteil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui ShopRemotei aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada ShopRemotei taustateenust."),
        ...
        ("About ShopRemote", "ShopRemotei teave"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Täiendage ShopRemotei klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
