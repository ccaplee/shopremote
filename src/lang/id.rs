...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke ShopRemote..."),
        ...
        ("install_tip", "Karena UAC, ShopRemote tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal ShopRemote ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk ShopRemote."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk ShopRemote."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd ShopRemote untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input ShopRemote]."),
        ...
        ("Language", "Bahasa"),
        ("Keep ShopRemote background service", "Pertahankan ShopRemote berjalan pada service background"),
        ...
        ("Show ShopRemote", "Tampilkan ShopRemote"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada ShopRemote"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada ShopRemote"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC ShopRemote yang sedang berjalan"),
        ...
        ("verify_shopremote_password_tip", "Verifikasi Kata Sandi ShopRemote"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan ShopRemote, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Silahkan perbarui ShopRemote Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah ShopRemote berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh ShopRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela ShopRemote sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service ShopRemote agar tetap aktif"),
        ...
        ("About ShopRemote", "Tentang ShopRemote"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Silahkan perbarui aplikasi ShopRemote ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
