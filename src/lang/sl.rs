...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem ShopRemote..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, ShopRemote v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate ShopRemoteu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate ShopRemoteu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno ShopRemoteu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »ShopRemote Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep ShopRemote background service", "Ohrani ShopRemoteovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije ShopRemote, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "ShopRemote potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "ShopRemote potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_shopremote_password_tip", "Preveri geslo za ShopRemote"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite ShopRemote, prekinite klic in program zaprite."),
        ("scam_text2", "ShopRemote omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Prosimo, nadgradite ShopRemote Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo ShopRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno ShopRemotea odprto"),
        ...
        ("floating_window_tip", "Pomaga pri ShopRemote storitvi v ozadju"),
        ...
        ("About ShopRemote", "O ShopRemoteu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_shopremote_client_to_{}_tip", "Prosimo, nadgradite ShopRemote odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
