...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do ShopRemote..."),
        ...
        ("install_tip", "Devido ao UAC, o ShopRemote não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o ShopRemote no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao ShopRemote permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao ShopRemote permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o ShopRemote use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [ShopRemote Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep ShopRemote background service", "Manter o serviço do ShopRemote executando em segundo plano"),
        ...
        ("Show ShopRemote", "Exibir ShopRemote"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do ShopRemote."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do ShopRemote."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do ShopRemote."),
        ...
        ("verify_shopremote_password_tip", "Verifique a senha do ShopRemote"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o ShopRemote e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Atualize o ShopRemote Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o ShopRemote funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por ShopRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do ShopRemote estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço ShopRemote em segundo plano"),
        ...
        ("About ShopRemote", "Sobre ShopRemote"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Atualize o cliente ShopRemote para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o ShopRemote verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o ShopRemote ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o ShopRemote não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor ShopRemote OSS não inclui este recurso."),
