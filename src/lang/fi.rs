...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään ShopRemote verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa ShopRemote ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi ShopRemotein järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava ShopRemoteille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava ShopRemoteille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten ShopRemote daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota ShopRemoteille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli ShopRemote ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "ShopRemote palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa ShopRemotein asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "ShopRemote palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep ShopRemote background service", "Pidä ShopRemotein taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista ShopRemotein akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show ShopRemote", "Näytä ShopRemote"),
        ...
        ("verify_shopremote_password_tip", "Vahvista ShopRemote salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "ShopRemote ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Päivitä ShopRemote Server Pro versioon {} jatkaaksesi."),
        ...
        ("About ShopRemote", "Tietoa ShopRemoteistä"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Päivitä etä-ShopRemote-asiakasversioon {} yhteensopivuuden takaamiseksi"),
