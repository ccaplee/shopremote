...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete ShopRemote..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), ShopRemote potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare ShopRemote a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a ShopRemote il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a ShopRemote il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a ShopRemote di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [ShopRemote Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep ShopRemote background service", "Mantieni il servizio di ShopRemote in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione ShopRemote, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show ShopRemote", "Visualizza ShopRemote"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a ShopRemote 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a ShopRemote."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di ShopRemote."),
        ...
        ("verify_shopremote_password_tip", "Conferma password ShopRemote"),
        ...
        ("Exit", "Esci da ShopRemote"),
        ("Open", "Apri ShopRemote"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare ShopRemote e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "Aggiorna ShopRemote Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di ShopRemote come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da ShopRemote"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra ShopRemote è aperta"),
        ...
        ("About ShopRemote", "Info su ShopRemote"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "Aggiorna il client ShopRemote remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, ShopRemote verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, ShopRemote salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, ShopRemote non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server ShopRemote non include questa funzionalità."),
