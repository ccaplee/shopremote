...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة ShopRemote..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. ShopRemote قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت ShopRemote في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح ShopRemote اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح ShopRemote اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ ShopRemote باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [ShopRemote Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep ShopRemote background service", "ابق خدمة ShopRemote تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق ShopRemote, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show ShopRemote", "عرض ShopRemote"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من ShopRemote اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح ShopRemote اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في ShopRemote الذي يعمل."),
        ...
        ("verify_shopremote_password_tip", "تحقق من كلمة مرور ShopRemote"),
        ...
        ("upgrade_shopremote_server_pro_to_{}_tip", "ترقية خادم ShopRemote Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع ShopRemote"),
        ...
        ("About ShopRemote", "حول ShopRemote"),
        ...
        ("upgrade_remote_shopremote_client_to_{}_tip", "ترقية عميل ShopRemote البعيد إلى {}"),
