...
class ShopremoteImpl implements Shopremote {
  final ShopremotePlatform _platform;
  factory ShopremoteImpl(ExternalLibrary dylib) =>
      ShopremoteImpl.raw(ShopremotePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory ShopremoteImpl.wasm(FutureOr<WasmModule> module) =>
      ShopremoteImpl(module as ExternalLibrary);
  ShopremoteImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
class ShopremotePlatform extends FlutterRustBridgeBase<ShopremoteWire> {
  ShopremotePlatform(ffi.DynamicLibrary dylib) : super(ShopremoteWire(dylib));
...
class ShopremoteWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ShopremoteWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ShopremoteWire.fromLookup(
