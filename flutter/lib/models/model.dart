...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsShopRemoteVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsShopRemoteVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsShopRemoteVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get ShopRemoteVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsShopRemoteVirtualDisplays] ?? []);
