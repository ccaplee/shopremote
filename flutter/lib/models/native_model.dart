...
class PlatformFFI {
  ...
  ShopremoteImpl get ffiBind => _ffiBind;
    ...
    final dylib = isAndroid
        ...
        : isLinux
            ...
            : isWindows
                ...
                //
                // isMacOS? DynamicLibrary.open("liblibshopremote.dylib") :
  ...
  void _startListenEvent(ShopremoteImpl rustdeskImpl) {
    final appType =
